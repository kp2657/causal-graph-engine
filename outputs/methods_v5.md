...
**CAD nominations.** The GWAS-validated atherogenic drivers *COL4A1* and *LOX* both reside in the ALDH2-anchored cluster (τ*-weighted). Among the 750 no-GWAS CAD targets, three satisfy the selection criteria: *CHRNA5* (criterion A: ALDH2 cluster; rank 15, γ=−1.024 — strongest negative-γ no-GWAS gene in the cluster; encodes nicotinic acetylcholine receptor α5, expressed in vascular endothelium where it modulates EC inflammation and tone), *SLC39A14* (criterion A: ALDH2 cluster; rank 41, γ=−0.935 — zinc/manganese transporter implicated in ferroptosis and lipid-oxidation in EC; metal-ion homeostasis is a plausible atherogenic mechanism in the same ECM-remodelling program space as COL4A1), and *THSD7A* (criteria A+B: ALDH2 cluster member and heritable cosine=0.775 to COL4A1 — highest dual support; encodes thrombospondin type I domain-containing protein 7A, an ECM glycoprotein structurally related to COL4A1's interaction partners, with endothelial expression and emerging roles in vascular inflammation).
