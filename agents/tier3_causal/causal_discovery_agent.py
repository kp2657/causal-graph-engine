...
from agents.tier3_causal.causal_therapeutic import _maybe_therapeutic_redirection
...
def run(
    ...
    # Program membership from Tier 2 regulatory_genomics_agent (may be empty).
